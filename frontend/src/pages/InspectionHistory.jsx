          ...
          <div>
            ...
            <div className="block md:hidden divide-y divide-slate-100">
              {inspectionsList.map((insp) => {
                ...
                return (
                  <div key={insp.id} className="p-4 space-y-2.5 hover:bg-slate-50 transition">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-500 mt-0.5">
                        {insp.brand ? `${insp.brand} • ` : ''}{insp.category}
                      </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between text-xs pt-1 border-t border-slate-100 text-slate-600">
                      <div>
                        <span>Score: </span>
                        <strong className="font-mono text-slate-900">{insp.complianceScore}%</strong>
                        <span className="mx-1.5">•</span>
                        <span>Violations: </span>
                        <strong className={`font-mono ${insp.failedChecksCount > 0 ? 'text-rose-600' : 'text-slate-700'}`}>
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <Link
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 py-2 px-3 bg-blue-50 hover:bg-blue-100 text-blue-700 text-xs font-semibold rounded-lg transition min-h-[38px]"
                      >
                      ...
                      {insp.status === 'analyzed' && (
                        <a
                          ...
                          className="inline-flex items-center justify-center p-2 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg transition min-h-[38px] min-w-[38px]"
                          title="Download PDF"
                        >
